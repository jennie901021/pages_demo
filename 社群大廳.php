        ...
        <div class="container">
            <div class="left">
                <div class="container-1">
                    <div class="top">
                        <a href="主畫面"><span class="h-1-1">&larr;返回登入頁面</span></a>
                        <span class="h-1">社群大廳</span>
                    </div>
                    <div class="bottom">
                        <img class="img6-2" height="200px" width="auto" src="畢專介面/畢專06-2.png" alt="無法顯示"></img>
                        <a href="我的社群.php"><span class="h-2">我的社群</span></a>
                    </div>
                </div>
            </div>
            <div class="right">
                <div class="container-1">
                    <div class="top"></div>
                    <div class="bottom">
                        <button onclick="goToAnotherPage()" class="circle">建立社群</button>
                        <script src="人物生成.js"></script>
